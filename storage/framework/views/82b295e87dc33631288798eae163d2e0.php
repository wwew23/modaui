...
<?php endif; ?>
        ...
        <div class="flex-fill">
            <h5 class="mb-1"><?php echo e(trans('packages/widget::widget.cache_suggestion.title')); ?></h5>
            <p class="mb-1">
                <?php echo e(trans('packages/widget::widget.cache_suggestion.description')); ?>

                <?php echo e(trans('packages/widget::widget.cache_suggestion.benefits')); ?>

            </p>
            <div class="mt-2">
                <a
                    href="<?php echo e(route('settings.cache')); ?>#widget-cache-settings"
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                    <?php echo e(trans('packages/widget::widget.cache_suggestion.enable_button')); ?>
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                    <?php echo e(trans('packages/widget::widget.cache_suggestion.dismiss_button')); ?>
...
<?php /**PATH /www/wwwroot/modaui.com/platform/packages/widget/resources/views/partials/widget-cache-suggestion.blade.php ENDPATH**/ ?>