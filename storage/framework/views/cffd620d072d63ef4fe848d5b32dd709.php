<?php if(!is_in_admin() || (Auth::guard()->check() && Auth::guard()->user()->hasPermission($route['edit']))): ?>
    <a
        data-bs-toggle="tooltip"
        data-bs-original-title="<?php echo e(trans('plugins/language::language.edit_related')); ?>"
        href="<?php echo e(Route::has($route['edit']) ? route($route['edit'], $relatedLanguage) : '#'); ?>"
    >
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /www/wwwroot/modaui.com/platform/plugins/language/resources/views/partials/status/edit.blade.php ENDPATH**/ ?>