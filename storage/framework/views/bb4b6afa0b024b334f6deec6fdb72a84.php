<link
    rel="stylesheet"
    href="<?php echo e(asset('vendor/core/core/base/libraries/intl-tel-input/css/intlTelInput.min.css')); ?>"
>
    ...
    (function() {
        ...
        function initPhoneNumberFields() {
            document.querySelectorAll('.js-phone-number-mask[data-country-code-selection="true"]').forEach(function(element) {
                ...
                const availableCountries = <?php echo json_encode($availableCountries, 15, 512) ?>;
                ...
                const config = {
                    ...
                    initialCountry: 'auto',
                    utilsScript: '<?php echo e(asset('vendor/core/core/base/libraries/intl-tel-input/js/utils.js')); ?>',
                };
...
<?php /**PATH /www/wwwroot/modaui.com/platform/core/base/resources/views/forms/fields/phone-number-script.blade.php ENDPATH**/ ?>