            ...
            document.querySelectorAll('[data-bb-toggle-password]').forEach(function(button) {
                ...
                button.addEventListener('click', function(e) {
                    ...
                    if (passwordField.getAttribute('type') === 'password') {
                        ...
                        this.innerHTML = `<?php echo BaseHelper::renderIcon('ti ti-eye-off'); ?>`;
                    } else {
                        passwordField.setAttribute('type', 'password');
                        this.innerHTML = `<?php echo BaseHelper::renderIcon('ti ti-eye'); ?>`;
                    }
                });
            });
        }
...
<?php /**PATH /www/wwwroot/modaui.com/platform/core/base/resources/views/forms/fields/password-toggle-script.blade.php ENDPATH**/ ?>