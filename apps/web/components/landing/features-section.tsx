...
const features = [
  {
    number: "01",
    title: "一句话极速生成店面",
    description: "只需在输入框表达你心仪的设计设想、商品类型和客群。我们的智能建店引擎将在几秒之内直接渲染成套自适应、带独立收款、导购的整栋精美零售界面。",
    visual: "deploy",
  },
  {
    number: "02",
    title: "多模态语音智能导购",
    description: "打破繁冗的检索，内置语音指引和搜寻能力。消费者可以随时使用随心开口说话或随拍发配，即刻由智能客服理解，享受极其体贴的拟人选购温度。",
    visual: "ai",
  },
  {
    number: "03",
    title: "闭环聚合极度安全结算",
    description: "自动连接聚合支付、扫码及多渠道收单汇兑。系统零代码，也无需自行寻找三方机构联调，让您的优质零售站真正做到开箱即售、收益即时妥帖入账。",
    visual: "collab",
  },
  {
    number: "04",
    title: "高品质安心交易托管",
    description: "全面符合国际卡片及线上收单交易规范，免去频繁退风控账期或网络恶意环境隐忧。为精美独立作品的长效稳健经营 and 货品流转提供强效支持。",
    visual: "security",
  },
];
        ...
        return (
          <g key={i}>
            ...
            <line
              x1="100"
              y1="80"
              x2={(100 + Math.cos(angle) * radius).toFixed(4)}
              y2={(80 + Math.sin(angle) * radius).toFixed(4)}
              stroke="currentColor"
              strokeWidth="1"
              opacity="0.3"
            >
            ...
            {/* Outer node */}
            <circle
              cx={(100 + Math.cos(angle) * radius).toFixed(4)}
              cy={(80 + Math.sin(angle) * radius).toFixed(4)}
              r="6"
              fill="none"
              stroke="currentColor"
              strokeWidth="2"
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            您所需要的一切，
            <br />
            <span className="text-muted-foreground">开箱即用，智能无缝。</span>
          </h2>
        </div>
