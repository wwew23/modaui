...
export type ActionSource = 'ai' | 'user' | 'legacy' | 'api';
...
export const ACTION_REGISTRY: Record<string, string[]> = {
  ...
  'core.customer': ['create', 'find'],
  'core.order': ['create', 'updateStatus'],
  'shopify.product': ['update', 'variants.bulkUpdate', 'tags.update', 'metafields.update', 'inventory.update'],
  'shopify.theme': ['section.update', 'asset.update', 'publish', 'template.update'],
...
const RULES: ActionPermissionRule[] = [
  ...
  // Core Domain
  { domain: 'core.product', action: 'create', allowSources: ['ai', 'user', 'api'] },
  { domain: 'core.product', action: 'update', allowSources: ['ai', 'user', 'api'] },
  { domain: 'core.product', action: 'delete', allowSources: ['user', 'api'] },
  { domain: 'core.customer', action: 'create', allowSources: ['ai', 'user', 'api'] },
  { domain: 'core.customer', action: 'find', allowSources: ['ai', 'user', 'api'] },
  { domain: 'core.order', action: 'create', allowSources: ['ai', 'user', 'api'] },
  { domain: 'core.order', action: 'updateStatus', allowSources: ['ai', 'user', 'api'] },
