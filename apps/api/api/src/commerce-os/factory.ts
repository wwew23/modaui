...
export function createCommerceOS(): CommerceOS {
  ...
  const coreProductLibrary = new CoreProductActionLibrary();
  const coreCustomerLibrary = new CoreCustomerActionLibrary();
  const coreOrderLibrary = new CoreOrderActionLibrary();
