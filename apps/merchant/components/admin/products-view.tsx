      ...
      <div className="flex-shrink-0 border-b border-border bg-card/80 backdrop-blur-sm">
        <div className="px-6 py-5">
          <div className="flex items-center justify-between mb-5">
            <div>
              <h1 className="text-2xl font-semibold text-foreground tracking-tight">商品 · 李设计师</h1>
              <p className="text-sm text-muted-foreground mt-1">管理商品展示、定价与库存，由 AI 设计师协助优化</p>
            </div>
