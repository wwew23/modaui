  ...
  sections: [
    {
      ...
      type: "hero",
      title: "纯粹声音，触手可及",
      subtitle: "采用自研旗舰级声学引擎，定制您的专属静谧音舱",
      cta: "立即探索",
      background: "#f8fafc"
    },
    {
      ...
      title: "为什么选择我们",
      features: [
        { icon: "🎧", title: "自研大单体", description: "纳米级晶格振膜架构" },
        { icon: "🔋", title: "48H续航", description: "全负荷超强能量控制" },
        { icon: "🎯", title: "自适应降噪", description: "旗舰级五处理器运算" }
      ]
    },
    {
      id: "products-1",
      ...
      title: "热门商品",
      products: [
        { name: "智能降噪耳机 Pro", price: "¥1,299", image: "https://picsum.photos/300/300?random=1" },
        { name: "无线立体声套装", price: "¥2,199", image: "https://picsum.photos/300/300?random=2" },
        { name: "便携蓝牙音箱", price: "¥699", image: "https://picsum.photos/300/300?random=3" }
      ]
    }
  ]
}
...
export function AIStoreEditor() {
  ...
  const handleGenerate = async () => {
    ...
    const generatedStore = { ...sampleStoreJSON }
    
    if (keywords.includes("服装") || keywords.includes("时尚")) {
      generatedStore.sections[0].title = "潮流时尚，尽在掌握"
      generatedStore.sections[0].subtitle = "探索2026春季最新潮流单品"
    } else if (keywords.includes("咖啡") || keywords.includes("饮品")) {
      generatedStore.sections[0].title = "每一杯，都是故事"
      generatedStore.sections[0].subtitle = "精选全球优质咖啡豆"
    }
