    ...
    @else
        <div style="padding: 20px; background: #fff; border: 1px solid #e5e7eb; border-radius: 16px; box-shadow: 0 10px 30px rgba(15, 23, 42, 0.06);">
            ...
            <div style="margin-top: 20px;">
                <a href="{{ route('ai-commerce.dashboard') }}" style="display: inline-block; padding: 12px 20px; background: #111827; color: #fff; border-radius: 12px; text-decoration: none;">前往 AI 智能中心</a>
            </div>
        </div>
    @endif
@endsection
