...
return [
    ...
    'cart' => [
        'added_to_cart_success' => ':product がカートに追加されました。',
        'removed_from_cart_success' => ':product がカートから削除されました。',
        'updated_cart_success' => 'カートが更新されました。',
        'item_not_found' => 'この商品はカートにありません。',
        'out_of_stock' => '申し訳ございません、:product は現在在庫切れです。',
        'max_quantity' => '最大 :max 個まで追加できます。',
        'max_quantity_detail' => '申し訳ございません、:product は一度に :quantity 個までしか注文できません。',
        'select_options' => 'カートに追加する前に製品オプションを選択してください。',
        'product_out_of_stock' => '申し訳ございません、この製品は現在在庫切れです。',
        'product_not_exists' => 'この製品は在庫切れか存在しません。',
        'not_enough_quantity' => '一部の製品は更新するのに十分な在庫がありません。',
        'empty_success' => 'カートが空になりました。',
    ],
    'wishlist' => [
        'added_success' => ':product がお気に入りに追加されました。',
        'removed_success' => ':product がお気に入りから削除されました。',
        'product_not_found' => 'この製品は見つかりませんでした。',
        'product_not_in_wishlist' => 'この製品はお気に入りにありません。',
        'product_not_available' => 'この製品は利用できません。',
    ],
    'compare' => [
        'added_success' => ':product が比較リストに追加されました。',
        'removed_success' => ':product が比較リストから削除されました。',
        'product_not_found' => 'この製品は見つかりませんでした。',
        'product_not_in_compare' => 'この製品は比較リストにありません。',
        'already_in_list' => ':product はすでに比較リストにあります。',
    ],
];
