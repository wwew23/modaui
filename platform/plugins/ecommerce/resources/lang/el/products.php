...
return [
    ...
    'cart' => [
        ...
        'out_of_stock' => 'Λυπούμαστε, το :product δεν είναι διαθέσιμο αυτή τη στιγμή.',
        'max_quantity' => 'Μπορείτε να προσθέσετε μέχρι :max προϊόντα.',
        'max_quantity_detail' => 'Λυπούμαστε, μπορείτε να παραγγείλετε μέχρι :quantity μονάδες :product τη φορά.',
        'select_options' => 'Παρακαλώ επιλέξτε τις επιλογές προϊόντος πριν προσθέσετε στο καλάθι.',
        'product_out_of_stock' => 'Λυπούμαστε, αυτό το προϊόν δεν είναι διαθέσιμο αυτή τη στιγμή.',
        'product_not_exists' => 'Αυτό το προϊόν δεν είναι διαθέσιμο ή δεν υπάρχει πλέον.',
    ...
    'compare' => [
        'added_success' => 'Το :product προστέθηκε στη λίστα σύγκρισης.',
        'removed_success' => 'Το :product αφαιρέθηκε από τη λίστα σύγκρισης.',
        'product_not_found' => 'Αυτό το προϊόν δεν βρέθηκε.',
        'product_not_in_compare' => 'Αυτό το προϊόν δεν βρίσκεται στη λίστα σύγκρισης.',
        'already_in_list' => 'Το :product βρίσκεται ήδη στη λίστα σύγκρισης.',
    ],
];
