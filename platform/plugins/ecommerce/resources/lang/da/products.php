...
return [
    ...
    'cart' => [
        'added_to_cart_success' => ':product er tilføjet til din kurv.',
        'removed_from_cart_success' => ':product er fjernet fra din kurv.',
        'updated_cart_success' => 'Din kurv er opdateret.',
        'item_not_found' => 'Denne vare er ikke længere i din kurv.',
        'out_of_stock' => 'Beklager, :product er i øjeblikket udsolgt.',
        'max_quantity' => 'Du kan kun tilføje op til :max varer.',
        'max_quantity_detail' => 'Beklager, du kan kun bestille :quantity enheder af :product ad gangen.',
        'select_options' => 'Vælg venligst produktindstillinger før tilføjelse til kurv.',
        'product_out_of_stock' => 'Beklager, dette produkt er i øjeblikket udsolgt.',
    ...
    'wishlist' => [
        ...
        'removed_success' => ':product er fjernet fra din ønskeliste.',
        'product_not_found' => 'Dette produkt kunne ikke findes.',
        'product_not_in_wishlist' => 'Dette produkt er ikke på din ønskeliste.',
        'product_not_available' => 'Dette produkt er ikke tilgængeligt.',
    ],
    'compare' => [
        'added_success' => ':product er tilføjet til din sammenligningsliste.',
        'removed_success' => ':product er fjernet fra din sammenligningsliste.',
        'product_not_found' => 'Dette produkt kunne ikke findes.',
        'product_not_in_compare' => 'Dette produkt er ikke på din sammenligningsliste.',
        'already_in_list' => ':product er allerede på din sammenligningsliste.',
    ],
];
