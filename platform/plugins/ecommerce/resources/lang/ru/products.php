...
return [
    ...
    'pending_revenue' => 'Ожидающий доход',
    ...
    'cart' => [
        'added_to_cart_success' => ':product добавлен в корзину.',
        'removed_from_cart_success' => ':product удален из корзины.',
        'updated_cart_success' => 'Корзина обновлена.',
        'item_not_found' => 'Этого товара больше нет в корзине.',
        'out_of_stock' => 'Извините, :product в настоящее время нет в наличии.',
        'max_quantity' => 'Вы можете добавить максимум :max товаров.',
        'max_quantity_detail' => 'Извините, вы можете заказать только :quantity единиц :product за раз.',
        'select_options' => 'Пожалуйста, выберите опции товара перед добавлением в корзину.',
        'product_out_of_stock' => 'Извините, этот товар в настоящее время отсутствует.',
        'product_not_exists' => 'Этот товар отсутствует или больше не существует.',
        'not_enough_quantity' => 'Некоторые товары не имеют достаточного количества для обновления.',
        'empty_success' => 'Корзина очищена.',
    ],
    'wishlist' => [
        'added_success' => ':product добавлен в список желаний.',
        'removed_success' => ':product удален из списка желаний.',
        'product_not_found' => 'Этот товар не найден.',
        'product_not_in_wishlist' => 'Этого товара нет в вашем списке желаний.',
        'product_not_available' => 'Этот товар недоступен.',
    ],
    'compare' => [
        'added_success' => ':product добавлен в список сравнения.',
        'removed_success' => ':product удален из списка сравнения.',
        'product_not_found' => 'Этот товар не найден.',
        'product_not_in_compare' => 'Этого товара нет в списке сравнения.',
        'already_in_list' => ':product уже в списке сравнения.',
    ],
];
