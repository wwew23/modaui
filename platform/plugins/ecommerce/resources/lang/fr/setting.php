...
return [
    ...
    'general' => [
        'name' => 'Général',
        'description' => 'Nom du magasin, infos société, coordonnées et emails de notification admin',
    ],
    'currency' => [
        'name' => 'Devises',
        'description' => 'Formats de devise, taux de change, détection auto et séparateurs décimaux/milliers',
    ...
    'product' => [
        'name' => 'Produits',
        'description' => 'Affichage stock, génération SKU, images variantes, produits associés et spécifications',
    ...
    'product_search' => [
        ...
        'description' => 'Comportement de recherche, filtres par catégorie/marque/tag/attributs et filtrage par prix',
    ...
    'digital_product' => [
        ...
        'description' => 'Produits téléchargeables, codes de licence, paiement invité pour produits numériques et complétion auto',
    ...
    'product_review' => [
        ...
        'description' => 'Avis clients, affichage notes, téléchargement images et exigences d\'approbation',
        'form' => [
    ...
    'shopping' => [
        ...
        'description' => 'Panier, liste de souhaits, comparaison, suivi commandes, bouton achat rapide et preuve de paiement',
        ...
        'form' => [
            ...
            'hide_product_price_when_zero' => 'Masquer le prix du produit lorsqu’il est égal à zéro',
            'hide_product_price_when_zero_helper' => 'Si activé, les produits dont le prix est 0 n’afficheront pas de prix sur la boutique.',
    ...
    'checkout' => [
        'name' => 'Commande',
        'panel_description' => 'Paiement invité, champs obligatoires, limites de commande, acceptation des conditions et restrictions pays',
    ...
    'return' => [
        ...
        'panel_description' => 'Retours de commandes, retours partiels et délais de retour',
        'form' => [
    ...
    'invoice' => [
        'name' => 'Factures',
        'description' => 'Détails société sur factures, numérotation factures, polices PDF et paramètres de tampon',
    ...
    'tax' => [
        ...
        'form' => [
            ...
            'display_product_price_including_taxes' => 'Ajouter la taxe aux prix affichés',
            'display_product_price_including_taxes_helper' => 'Ajoute automatiquement la taxe aux prix des produits affichés sur la boutique. Ex : un produit à 100 $ avec 10 % de taxe affichera 110 $. Inutile si « Le prix inclut la taxe » est déjà activé sur les produits individuels.',
    ...
    'customer' => [
        'name' => 'Clients',
        'description' => 'Inscription, vérification email, options de connexion, suppression de compte et champs de profil',
    ...
    'shipping' => [
        'name' => 'Livraison',
        'description' => 'Règles de livraison, comportement livraison gratuite et ordre d\'affichage des options',
    ...
    'store_locator' => [
        ...
        'info' => [
            'title' => 'Comment fonctionnent les localisateurs de magasins',
            'primary_store' => 'L\'adresse du magasin principal apparaît sur les factures et est utilisée comme adresse de retour par défaut pour les étiquettes d\'expédition.',
            'shipping_location' => 'Les magasins marqués comme "lieu d\'expédition" peuvent être sélectionnés comme entrepôt d\'origine lors de la création d\'expéditions.',
            'shipment_selection' => 'Lors du traitement des commandes, vous pouvez choisir depuis quel entrepôt expédier en fonction de l\'inventaire et de l\'emplacement du client.',
        ],
    ],
    'tracking' => [
        'name' => 'Suivi',
        'description' => 'Facebook Pixel, événements Google Tag Manager et suivi des conversions Google Ads',
    ...
    'marketplace' => [
        ...
        'description' => 'Paramètres multi-vendeurs, commissions, inscription vendeurs et configuration des paiements',
    ],
    'standard_and_format' => [
        'name' => 'Standard et Format',
        'panel_description' => 'Format de code commande, unités de poids (kg/lb) et unités de dimension (cm/pouce)',
    ...
    'payment_method_cod_minimum_amount_helper' => 'Définir le montant minimum de commande requis pour utiliser le mode de paiement COD. Laissez à 0 ou vide si vous ne souhaitez pas définir de minimum.',
    'payment_method_cod_maximum_amount' => 'Montant maximum de commande - :currency (Optionnel)',
    'payment_method_cod_maximum_amount_helper' => 'Définir le montant maximum de commande autorisé pour le mode de paiement COD. Laissez à 0 ou vide si vous ne souhaitez pas définir de maximum.',
    'payment_method_minimum_amount' => 'Montant minimum de commande - :currency (Optionnel)',
    'payment_method_minimum_amount_helper' => 'Définir le montant minimum de commande requis pour utiliser ce mode de paiement. Laissez à 0 ou vide si vous ne souhaitez pas définir de minimum.',
    'payment_method_maximum_amount' => 'Montant maximum de commande - :currency (Optionnel)',
    'payment_method_maximum_amount_helper' => 'Définir le montant maximum de commande autorisé pour ce mode de paiement. Laissez à 0 ou vide si vous ne souhaitez pas définir de maximum.',
    'payment_method_maximum_amount_error' => 'Le montant maximum de commande pour utiliser le mode de paiement :payment_method est :amount, vous devez retirer :more pour passer commande!',
    'display_bank_info_at_the_checkout_success_page' => 'Afficher les informations bancaires sur la page de succès de commande ?',
    'display_bank_info_at_the_checkout_success_page_helper' => 'Lorsque cette option est activée, les clients verront les coordonnées de votre compte bancaire sur la page de confirmation de commande après avoir passé une commande. Cela les aide à savoir où transférer le paiement.',
    'invoice_templates' => 'Modèles de facture',

    'abandoned_cart' => [
        'name' => 'Paniers Abandonnés',
        'description' => 'Récupérez les ventes perdues en envoyant des rappels automatiques aux clients qui ont laissé des articles dans leur panier',
        'panel_description' => 'Configurez des rappels automatiques pour les clients qui abandonnent leur panier',
        'how_it_works' => [
            'title' => 'Comment ça marche',
            'step1_title' => 'Le client ajoute des articles',
            'step1_description' => 'Le client ajoute des produits à son panier et fournit son adresse e-mail.',
            'step2_title' => 'Le panier devient abandonné',
            'step2_description' => 'Si aucun achat n\'est effectué dans le délai défini, le panier est marqué comme abandonné.',
            'step3_title' => 'E-mail de rappel envoyé',
            'step3_description' => 'Des e-mails de rappel automatiques sont envoyés pour encourager le client à finaliser son achat.',
            'step4_title' => 'Vente récupérée',
            'step4_description' => 'Le client revient pour compléter sa commande et le panier est marqué comme récupéré.',
        ],
        'form' => [
            'enable' => 'Activer le suivi des paniers abandonnés',
            'enable_helper' => 'Une fois activé, le système suivra les paniers abandonnés et vous permettra d\'envoyer des e-mails de récupération aux clients.',
            'timing_section' => 'Paramètres de Temps',
            'email_section' => 'Paramètres des E-mails de Rappel',
            'cleanup_section' => 'Nettoyage des Données',
            'time_threshold' => 'Seuil de temps (heures)',
            'time_threshold_helper' => 'Un panier est considéré comme abandonné après ce nombre d\'heures d\'inactivité. Recommandé : 1-24 heures.',
            'send_email' => 'Envoyer des e-mails de récupération',
            'send_email_helper' => 'Envoyer automatiquement des e-mails de récupération aux clients avec des paniers abandonnés.',
            'max_reminders' => 'Nombre d\'e-mails de rappel',
            'max_reminders_helper' => 'Combien d\'e-mails de rappel envoyer par panier abandonné. Chaque e-mail peut être personnalisé dans les Modèles d\'E-mail.',
            'email_delay' => 'Envoyer après (heures)',
            'email_discount' => 'Réduction (%)',
            'email_1_title' => 'E-mail #1 - Rappel Amical',
            'email_1_description' => 'Premier rappel doux pour encourager le client à revenir.',
            'email_1_delay_helper' => 'Heures après l\'abandon du panier pour envoyer le premier e-mail. Recommandé : 1-2 heures.',
            'email_2_title' => 'E-mail #2 - Avec Incitation',
            'email_2_description' => 'Deuxième rappel avec offre de réduction pour motiver l\'achat.',
            'email_2_delay_helper' => 'Heures après l\'abandon du panier pour envoyer le deuxième e-mail. Recommandé : 24 heures.',
            'email_2_discount_helper' => 'Pourcentage de réduction à offrir dans cet e-mail. Mettre 0 pour aucune réduction.',
            'email_3_title' => 'E-mail #3 - Dernière Chance',
            'email_3_description' => 'Rappel final avec urgence et meilleure offre pour conclure la vente.',
            'email_3_delay_helper' => 'Heures après l\'abandon du panier pour envoyer le dernier e-mail. Recommandé : 72 heures.',
            'email_3_discount_helper' => 'Offre de réduction finale. Généralement supérieure à l\'e-mail #2.',
            'cleanup_days' => 'Nettoyer après (jours)',
            'cleanup_days_helper' => 'Supprimer automatiquement les enregistrements de paniers abandonnés plus anciens que ce nombre de jours.',
            'cronjob_not_setup' => '<strong>Cronjob non configuré !</strong> Les rappels de paniers abandonnés nécessitent un cronjob correctement configuré. <a href=":url">Configurer le cronjob maintenant</a>.',
            'cronjob_not_running' => '<strong>Cronjob ne fonctionne pas !</strong> Le cronjob semble s\'être arrêté. Veuillez vérifier la configuration de votre serveur. <a href=":url">Voir le statut du cronjob</a>.',
            'cronjob_working' => '<strong>Cronjob fonctionne correctement !</strong> Dernière activité : :time. Vos rappels de paniers abandonnés seront traités automatiquement.',
            'email_setup_warning' => '<strong>Important :</strong> Assurez-vous que vos paramètres e-mail sont correctement configurés dans <a href=":url">Paramètres → E-mail</a>. Envoyez un e-mail test pour vérifier que tout fonctionne avant d\'activer cette fonctionnalité.',
        ],
    ],
];
