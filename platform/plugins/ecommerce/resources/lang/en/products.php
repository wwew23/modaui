...
return [
    ...
    'form' => [
        ...
        'is_new_until' => 'New until',
        'is_new_until_helper' => 'Set a date until which this product will be marked as "New". Leave empty to not mark as new based on date.',
    ],
    'price' => 'Price',
    'quantity' => 'Quantity',
    'type' => 'Type',
    ...
    'cart' => [
        'added_to_cart_success' => ':product has been added to your cart.',
        'removed_from_cart_success' => ':product has been removed from your cart.',
        'updated_cart_success' => 'Your cart has been updated.',
        'item_not_found' => 'This item is no longer in your cart.',
        'out_of_stock' => 'Sorry, :product is currently out of stock.',
        'max_quantity' => 'You can only add up to :max items.',
        'max_quantity_detail' => 'Sorry, you can only order up to :quantity units of :product at a time.',
        'select_options' => 'Please select product options before adding to cart.',
        'product_out_of_stock' => 'Sorry, this product is currently out of stock.',
        'product_not_exists' => 'This product is out of stock or no longer exists.',
        'not_enough_quantity' => 'Some products do not have enough stock to update.',
        'empty_success' => 'Your cart has been emptied.',
    ],
    'wishlist' => [
        'added_success' => ':product has been added to your wishlist.',
        'removed_success' => ':product has been removed from your wishlist.',
        'product_not_found' => 'This product could not be found.',
        'product_not_in_wishlist' => 'This product is not in your wishlist.',
        'product_not_available' => 'This product is not available.',
    ],
    'compare' => [
        'added_success' => ':product has been added to your compare list.',
        'removed_success' => ':product has been removed from your compare list.',
        'product_not_found' => 'This product could not be found.',
        'product_not_in_compare' => 'This product is not in your compare list.',
        'already_in_list' => ':product is already in your compare list.',
    ],
];
