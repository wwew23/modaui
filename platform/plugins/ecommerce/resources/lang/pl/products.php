...
return [
    ...
    'pending_revenue' => 'Przychód oczekujący',
    ...
    'cart' => [
        'added_to_cart_success' => ':product został dodany do koszyka.',
        'removed_from_cart_success' => ':product został usunięty z koszyka.',
        'updated_cart_success' => 'Koszyk został zaktualizowany.',
        'item_not_found' => 'Ten produkt nie znajduje się już w koszyku.',
        'out_of_stock' => 'Przepraszamy, :product jest obecnie niedostępny.',
        'max_quantity' => 'Możesz dodać maksymalnie :max produktów.',
        'max_quantity_detail' => 'Przepraszamy, możesz zamówić tylko :quantity sztuk :product naraz.',
        'select_options' => 'Wybierz opcje produktu przed dodaniem do koszyka.',
        ...
        'not_enough_quantity' => 'Niektóre produkty nie mają wystarczającego zapasu do aktualizacji.',
        'empty_success' => 'Koszyk został opróżniony.',
    ],
    'wishlist' => [
        'added_success' => ':product został dodany do listy życzeń.',
        'removed_success' => ':product został usunięty z listy życzeń.',
        'product_not_found' => 'Nie znaleziono tego produktu.',
        'product_not_in_wishlist' => 'Ten produkt nie znajduje się na liście życzeń.',
        'product_not_available' => 'Ten produkt jest niedostępny.',
    ],
    'compare' => [
        'added_success' => ':product został dodany do listy porównawczej.',
        'removed_success' => ':product został usunięty z listy porównawczej.',
        'product_not_found' => 'Nie znaleziono tego produktu.',
        'product_not_in_compare' => 'Ten produkt nie znajduje się na liście porównawczej.',
        'already_in_list' => ':product jest już na liście porównawczej.',
    ],
];
