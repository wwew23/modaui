...
return [
    ...
    'cart' => [
        'added_to_cart_success' => ':product ha sido añadido a tu carrito.',
        'removed_from_cart_success' => ':product ha sido eliminado de tu carrito.',
        'updated_cart_success' => 'Tu carrito ha sido actualizado.',
        'item_not_found' => 'Este artículo ya no está en tu carrito.',
        'out_of_stock' => 'Lo sentimos, :product está agotado actualmente.',
        'max_quantity' => 'Solo puedes añadir hasta :max artículos.',
        'max_quantity_detail' => 'Lo sentimos, solo puedes pedir hasta :quantity unidades de :product a la vez.',
        'select_options' => 'Por favor selecciona las opciones del producto antes de añadir al carrito.',
        ...
        'empty_success' => 'Tu carrito ha sido vaciado.',
    ],
    'wishlist' => [
        'added_success' => ':product ha sido añadido a tu lista de deseos.',
        'removed_success' => ':product ha sido eliminado de tu lista de deseos.',
        'product_not_found' => 'Este producto no pudo ser encontrado.',
        'product_not_in_wishlist' => 'Este producto no está en tu lista de deseos.',
        'product_not_available' => 'Este producto no está disponible.',
    ],
    'compare' => [
        'added_success' => ':product ha sido añadido a tu lista de comparación.',
        'removed_success' => ':product ha sido eliminado de tu lista de comparación.',
        'product_not_found' => 'Este producto no pudo ser encontrado.',
        'product_not_in_compare' => 'Este producto no está en tu lista de comparación.',
        'already_in_list' => ':product ya está en tu lista de comparación.',
    ],
];
