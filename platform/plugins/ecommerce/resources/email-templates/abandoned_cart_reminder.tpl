    ...
    <table class="bb-box" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td class="bb-content bb-pb-0" align="center">
                ...
                <h1 class="bb-text-center bb-m-0 bb-mt-md">{{ 'plugins/ecommerce::email-templates.abandoned_cart_reminder_title' | trans }}</h1>
            </td>
        </tr>
        <tr>
            <td class="bb-content">
                <p>{{ 'plugins/ecommerce::email-templates.abandoned_cart_greeting' | trans({'customer_name': customer_name}) }}</p>
                <div>{{ 'plugins/ecommerce::email-templates.abandoned_cart_message' | trans }}</div>
            </td>
        </tr>
        <tr>
