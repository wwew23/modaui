    ...
    <table class="bb-box" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td class="bb-content bb-pb-0" align="center">
                ...
                <h1 class="bb-text-center bb-m-0 bb-mt-md">{{ 'plugins/ecommerce::email-templates.abandoned_cart_reminder_3_title' | trans }}</h1>
            </td>
        </tr>
        <tr>
            <td class="bb-content">
                <p>{{ 'plugins/ecommerce::email-templates.abandoned_cart_reminder_3_greeting' | trans({'customer_name': customer_name}) }}</p>
                <div>{{ 'plugins/ecommerce::email-templates.abandoned_cart_reminder_3_message' | trans }}</div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="bb-content bb-text-center bb-pt-0 bb-pb-xl">
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td align="center">
                            <table cellpadding="0" cellspacing="0" border="0" class="bb-bg-red bb-rounded bb-w-auto">
                                <tbody>
                                    <tr>
                                        <td align="center" valign="top" class="lh-1">
                                            <a href="{{ cart_recover_url }}" class="bb-btn bb-bg-red bb-border-red">
                                                <span class="btn-span">{{ 'plugins/ecommerce::email-templates.abandoned_cart_complete_now' | trans }}</span>
                                            </a>
                                        </td>
                                    </tr>
                                </tbody>
